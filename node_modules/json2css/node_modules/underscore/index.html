...
<head>
  ...
  <style>
    body {
      font-size: 14px;
      line-height: 22px;
      background: #f4f4f4 url(docsimages/background.png);
      color: #000;
...
<body>
  ...
  <div class="container">
    ...
    <p id="introduction">
      <img id="logo" src="docsimages/underscore.png" alt="Underscore.js" />
    </p>
...
=&gt; [1, 2, 3]
      ...
      <p>
        <a href="http://documentcloud.org/" title="A DocumentCloud Project" style="background:none;">
          <img src="http://jashkenas.s3.amazonaws.comimages/a_documentcloud_project.png" alt="A DocumentCloud Project" />
        </a>
      </p>
